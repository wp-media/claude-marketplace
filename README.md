...
| **Cadenza** | Four standalone utility agents — no pipeline required | `/plugin install cadenza@wp-media` |
...
### Cadenza
Four standalone utility agents — each with one job. Generate changelogs, write PR descriptions, author PHPUnit tests, and produce retrospective reports. Works on its own or alongside Maestro.
